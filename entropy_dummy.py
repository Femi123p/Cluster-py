...
#cEntropy=cluster_entropy(matrix,cluster_list)
#print (cEntropy)
...
for arr in gmm.predict_proba(matrix).tolist():
	...
	index2=index2+1
#c1Entropy=cluster_entropy(matrix,cluster_list1)
#print (c1Entropy)
...
for arr in gmm.predict_proba(matrix).tolist():		
	...
	index3=index3+1
#c2Entropy=cluster_entropy(matrix,cluster_list2)
#print (c2Entropy)
...
for arr in gmm.predict_proba(matrix).tolist():	
	...
	index4=index4+1
#c3Entropy=cluster_entropy(matrix,cluster_list3)
#print (c3Entropy)
...
for arr in gmm.predict_proba(matrix).tolist():		
	...
	index5=index5+1
#c4Entropy=cluster_entropy(matrix,cluster_list4)
#print (c4Entropy)
...
for arr in gmm.predict_proba(matrix).tolist():
	...
	index6=index6+1
#c5Entropy=cluster_entropy(matrix,cluster_list5)
#print (c5Entropy)
